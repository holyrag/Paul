...
zokou({ nomCom: "link", categorie: 'Group', reaction: "🙋" }, async (dest, zk, commandeOptions) => {
  ...
  if (!verifGroupe) { repondre("Hold on , you want the link to my dm?"); return; };
...
zokou({ nomCom: "GCname", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
