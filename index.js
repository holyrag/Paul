...
let evt = require(__dirname + "/framework/itachi");
...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['ITACHI-MD-pixel', "safari", "1.0.0"],
  ...
  try {
    ...
    try {
        ...
        if (botMsg || baileysMsg) {
           ...
           // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
            const gifLink = "https://raw.githubusercontent.com/djalega8000/ITACHI-MD-pixel/main/media/remover.gif";
            var sticker = new Sticker(gifLink, {
                pack: 'Zoou-Md',
                author: conf.OWNER_NAME,
                type: StickerTypes.FULL,
